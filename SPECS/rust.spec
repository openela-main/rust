...
# Fix CVE-2026-53587 for libgit2. This is fixed in libgit2 1.9.5.
Patch101:	rustc-1.92.0-libgit2-CVE-2026-53587.patch
...
* Thu Aug 27 2026 Paul Murphy <murp@redhat.com> - 1.92.0-2
- Apply libgit2 fix for CVE-2026-53587

* Wed Jan 07 2026 Josh Stone <jistone@redhat.com> - 1.92.0-1
- Update to Rust 1.92.0

* Wed Nov 05 2025 Paul Murphy <murp@redhat.com> - 1.91.0-1
- Update to Rust 1.91.0

* Tue Sep 30 2025 Paul Murphy <murp@redhat.com> - 1.90.0-1
- Update to Rust 1.90

* Mon Sep 15 2025 Jesus Checa Hidalgo <jchecahi@redhat.com> - 1.89.0-2
- Add unicode exceptions (rpminspect) for rust 1.89 update

* Wed Sep 10 2025 Josh Stone <jistone@redhat.com> - 1.89.0-1
...
* Wed Dec 04 2024 Josh Stone <jistone@redhat.com> - 1.83.0-1
- Update to Rust 1.83.0

* Mon Nov 04 2024 Josh Stone <jistone@redhat.com> - 1.82.0-1
- Update to Rust 1.82.0

* Wed Oct 30 2024 Jesus Checa Hidalgo <jchecahi@redhat.com> - 1.81.0-3
- Update rpminspect config with unicode rules

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 1.81.0-2
...
* Wed Oct 09 2024 Davide Cavalca <dcavalca@centosproject.org> - 1.79.0-4
